#!/bin/bash
# Exp4 - Cifar10:
# Model: cnn2, lr: 0.04, m: 8, k: 40, alpha: 0.5 (noniid, unbalanced, dir)
...
# python main.py --model cnn2 --dataset Cifar10 --lr 0.04 --ld True --exp 4 --device cuda --device_id 0 --m 8 --filter multi-krum --mp CAMP --CAMP_mode clipping_v8 --lamda 2 --pk all
# python main.py --model cnn2 --dataset Cifar10 --lr 0.04 --ld True --exp 4 --device cuda --device_id 0 --m 8 --filter maud-norm --mp CAMP --CAMP_mode clipping_v8 --lamda 2 --pk all --maud_window 5
...
echo "=== All Cifar10 exp4 experiments done! ==="
